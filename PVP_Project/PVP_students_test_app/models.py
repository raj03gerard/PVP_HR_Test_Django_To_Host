...
class Category(models.Model):
    ...
    color = models.CharField(max_length=10, choices=[(color.value, color.name) for color in Default_Category_Colors])
...
class Student(models.Model):
    ...
    evaluation_result = models.CharField(max_length=100, 
            choices=[(result_type.value, result_type.name) for result_type in Student_Evaluation_Results], 
